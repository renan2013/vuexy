    ...
    <vs-sidebar
      ...
      <div class="h-full">
        ...
        <div class="customizer-header mt-6 flex items-center justify-between px-6">
          <div>
            <h4>PERSONALICE</h4>
            <small>Su entorno de trabajo</small>
          </div>
        ...
        <component :is="scrollbarTag" class="scroll-area--customizer pt-4 pb-6" :settings="settings" :key="$vs.rtl">
          ...
          <div class="px-6">
            ...
            <!-- THEME COLORS -->
            <div>
              <h5 class="mb-4">Personalice su color</h5>
              <ul class="clearfix">
            ...
            <!-- RTL -->
            <!-- <div class="mt-4 flex justify-between">
              <h5 class="mb-2">Panel a la izquierda</h5>
