<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      <vs-dropdown-item @click="updateLocale('es')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/es.png" alt="es" /> &nbsp;Spanish</vs-dropdown-item>
...
export default {
  computed: {
    ...
    getCurrentLocaleData () {
      const locale = this.$i18n.locale
      if (locale === 'es')      return { flag: 'es', lang: 'Spanish'    }
