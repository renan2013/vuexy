  ...
  <div class="vx-navbar-wrapper navbar-full p-0">
    <vs-navbar class="navbar-custom navbar-skelton" :class="navbarClasses"  :style="navbarStyle" :color="navbarColor">
      ...
      <bookmarks :navbarColor="navbarColor" v-if="windowWidth >= 992" />
       ...
       <!-- Aqui se cambia el logo de la empresa en el modo normal  -->
      <router-link tag="div" to="/" class="vx-logo cursor-pointer mx-auto flex items-center">
        <img src="@/assets/images/logo/logo_divisoft.svg" width="200px">
        <!-- <logo class="w-10 mr-4 fill-current text-primary" /> -->
        <!-- <span class="vx-logo-text text-primary">divisoft</span> -->
      </router-link>
