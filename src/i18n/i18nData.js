...
export default {
  es: {
    ...
    SimpleCalendar: 'Simple Calendario',
    Shop: 'Tienda',
    ...
    Radio: 'Radio',
    Input: 'Entrada',
    NumberInput: 'Entrada numerica',
    Textarea: 'Area de texto',
    FormLayouts: 'Formulario Layouts',
    FormWizard: 'Formulario Wizard',
    ...
    StarRatings: 'Clasificación de estrellas',
    ...
    Others: 'Otros',
    MenuLevels: 'Niveles de menu',
    MenuLevel2p1: 'Nivel de menu 2.1',
    MenuLevel2p2: 'Nivel de menu 2.2',
    MenuLevel3p2: 'Nivel de menu 3.2',
    MenuLevel3p1: 'Nivel de menu 3.1',
    DisabledMenu: 'Menu deshabilitado',
    Support: 'Soporte',
    Documentation: 'Documentación',
    RaiseSupport: 'Elevar soporte',
    demoTitle: 'Titulo de tarjeta',
    demoText: 'Pastel de sésamo, magdalena, pan de jengibre danés Me encanta el pan de jengibre. Pastel de manzana pastel jujubes chupa chups muffin halvah lollipop. Tarta de chocolate tarta de avena tiramisú mazapán azúcar ciruela. Donut tarta dulce tarta de avena dragée tarta de frutas algodón de azúcar gotas de limón.'
  },
  en: {
    Dashboard: 'Dashboard',
    eCommerce: 'eCommerce',
